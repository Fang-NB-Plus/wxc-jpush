package eeui.android.eeuiJpush.receiver;
...
public class JPushReceiver  extends JPushMessageReceiver {
    ...
    public void onCheckTagOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        Log.d("yjp","callback  onCheckTagResult ");
    ...
    //    }
        ...
        if (jPushMessage.getErrorCode() == 0) {
            try {
                ...
                Log.d("yjp"," this tag :" + jPushMessage.getCheckTag());
    ...
    public void onAliasOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        Log.d("yjp"," callback  alias result ");
...
//
        ...
        Log.d("yjp"," etErrorCode(  "+   jPushMessage.getErrorCode() + "  //getAlias :" + jPushMessage.getAlias());
        if (jPushMessage.getErrorCode() == 0) { // success
            try {
